@extends('header')
@section('titleIcon', "beenhere")
@section('titleName', "Finalizar posição")
@section('containerPage')
<div class="row">
   <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/position/finish') }}">
      {{ csrf_field() }}
      ...
      <div class="row">
         <div class="input-field col s12">
            ...
            <label for="justifyNote">
               Justificativa no histórico do usuário
            </label>
         </div>
      </div>
      <div class="row">
         <div class="col s12">
            <button type="submit" class="btn transColor">Finalizar</button>
         </div>
      </div>
   </form>
</div>
